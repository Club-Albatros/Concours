 ...
 <tbody>
  <tr>
   ...
   <td>
    ...
    <asp:RegularExpressionValidator runat="server" ID="regCoordinatesStart" resourcekey="InvalidCoordinates.ErrorMessage" CssClass="dnnFormMessage dnnFormError" controltovalidate="txtCoordinatesStart" display="Dynamic" ValidationExpression="(\d{6}/\d{6})|(\d+\.\d+/\d+\.\d+)" />
   </td>
  </tr>
  <tr>
   ...
   <td>
    ...
    <asp:RegularExpressionValidator runat="server" ID="regCoordinatesA" resourcekey="InvalidCoordinates.ErrorMessage" CssClass="dnnFormMessage dnnFormError" controltovalidate="txtCoordinatesA" display="Dynamic" ValidationExpression="(\d{6}/\d{6})|(\d+\.\d+/\d+\.\d+)" />
   </td>
  </tr>
  <tr id="trC1">
   ...
   <td>
    ...
    <asp:RegularExpressionValidator runat="server" ID="regCoordinatesC1" resourcekey="InvalidCoordinates.ErrorMessage" CssClass="dnnFormMessage dnnFormError" controltovalidate="txtCoordinatesC1" display="Dynamic" ValidationExpression="(\d{6}/\d{6})|(\d+\.\d+/\d+\.\d+)" />
   </td>
  </tr>
  <tr id="trC2">
   ...
   <td>
    ...
    <asp:RegularExpressionValidator runat="server" ID="regCoordinatesC2" resourcekey="InvalidCoordinates.ErrorMessage" CssClass="dnnFormMessage dnnFormError" controltovalidate="txtCoordinatesC2" display="Dynamic" ValidationExpression="(\d{6}/\d{6})|(\d+\.\d+/\d+\.\d+)" />
   </td>
  </tr>
  <tr>
   ...
   <td>
    ...
    <asp:RegularExpressionValidator runat="server" ID="regCoordinatesB" resourcekey="InvalidCoordinates.ErrorMessage" CssClass="dnnFormMessage dnnFormError" controltovalidate="txtCoordinatesB" display="Dynamic" ValidationExpression="(\d{6}/\d{6})|(\d+\.\d+/\d+\.\d+)" />
   </td>
  </tr>
  <tr>
   ...
   <td>
    ...
    <asp:RegularExpressionValidator runat="server" ID="regCoordinatesLanding" resourcekey="InvalidCoordinates.ErrorMessage" CssClass="dnnFormMessage dnnFormError" controltovalidate="txtCoordinatesLanding" display="Dynamic" ValidationExpression="(\d{6}/\d{6})|(\d+\.\d+/\d+\.\d+)" />
   </td>
  </tr>
 </tbody>
</table>
